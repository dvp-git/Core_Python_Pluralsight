# Creating a Seat booking system ( With Re-location mechanism, Re-factorin of Aircraft class to 2 new Seprate Aircraftss and make_flight along with CardPrinter()
...
def main():
    f1 = Flight("AX19",AirbusA319("G-EUPT"))
    # print(f1._aircraft._num_rows)
    print(f1._aircraft.seating_plan())
    pp(f1._seating)
    f1.make_boarding_cards(card_printer)

    g1 = Flight("BA77",Boeing777("F-GSPS"))
    # print(f1._aircraft._num_rows)
    print(g1._aircraft.seating_plan())
    pp(g1._seating)
    g1.make_boarding_cards(card_printer)
...
def make_flights():
    f = Flight("AX19",AirbusA319("G-EUPT"))
...
>>> from MakeFlightAircraftPolymorphism import *
>>>
>>>
>>> make_flights()
(<MakeFlightAircraftPolymorphism.Flight object at 0x03070B30>, <MakeFlightAircraftPolymorphism.Flight object at 0x031B9F70>)
...
+---------------------------------------------------------------------------+
|                                                                           |
| Name : Anders Hejlsberg| Flight : AX19| Seat : 15E| Aircraft : Airbus-A319|
|                                                                           |
+---------------------------------------------------------------------------+
...
+----------------------------------------------------------------------------+
|                                                                            |
| Name : Bjarne Stroustrup| Flight : AX19| Seat : 15F| Aircraft : Airbus-A319|
|                                                                            |
+----------------------------------------------------------------------------+
...
+---------------------------------------------------------------------------+
|                                                                           |
| Name : Guido Van Rossum| Flight : AX19| Seat : 12A| Aircraft : Airbus-A319|
|                                                                           |
+---------------------------------------------------------------------------+
...
+-----------------------------------------------------------------------+
|                                                                       |
| Name : John McCarthy| Flight : AX19| Seat : 1C| Aircraft : Airbus-A319|
|                                                                       |
+-----------------------------------------------------------------------+
...
+---------------------------------------------------------------------+
|                                                                     |
| Name : Rich Mickey| Flight : AX19| Seat : 1D| Aircraft : Airbus-A319|
|                                                                     |
+---------------------------------------------------------------------+
...
+--------------------------------------------------------------------------+
|                                                                          |
| Name : Anders Hejlsberg| Flight : BA77| Seat : 15E| Aircraft : Boeing-777|
|                                                                          |
+--------------------------------------------------------------------------+
...
+---------------------------------------------------------------------------+
|                                                                           |
| Name : Bjarne Stroustrup| Flight : BA77| Seat : 15F| Aircraft : Boeing-777|
|                                                                           |
+---------------------------------------------------------------------------+
...
+--------------------------------------------------------------------------+
|                                                                          |
| Name : Guido Van Rossum| Flight : BA77| Seat : 12A| Aircraft : Boeing-777|
|                                                                          |
+--------------------------------------------------------------------------+
...
+----------------------------------------------------------------------+
|                                                                      |
| Name : John McCarthy| Flight : BA77| Seat : 1C| Aircraft : Boeing-777|
|                                                                      |
+----------------------------------------------------------------------+
...
+--------------------------------------------------------------------+
|                                                                    |
| Name : Rich Mickey| Flight : BA77| Seat : 1D| Aircraft : Boeing-777|
|                                                                    |
+--------------------------------------------------------------------+
